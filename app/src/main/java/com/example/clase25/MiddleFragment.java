...
public class MiddleFragment extends Fragment implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        texto = (EditText) this.getActivity().findViewById(R.id.txtTextoMedio);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Button buttonenviar = view.findViewById(R.id.btnMedio);
    ...
    public void onClick(View v) {
        ((MainActivity) getActivity()).enviarArriba();
    }
}