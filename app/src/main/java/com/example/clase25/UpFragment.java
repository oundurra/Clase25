...
public class UpFragment extends Fragment implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        texto = (EditText) this.getActivity().findViewById(R.id.txtTextoArriba);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Button buttonenviar = view.findViewById(R.id.btnArriba);
    ...
    public void onClick(View v) {
        //texto.setText("HOLA");
        ((MainActivity) getActivity()).enviarAlCentro();
    }
}